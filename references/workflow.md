...
Treat `网络首发` and `优先出版` as the Chinese equivalent of first-online publication only when the source page supplies the date. Do not use database ingest date or issue date as a substitute.
